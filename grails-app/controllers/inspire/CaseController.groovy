...
class CaseController {
    ...
    def save(Case caseInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'case.label', default: 'Case'), caseInstance.id])
    ...
    def update(Case caseInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'Case.label', default: 'Case'), caseInstance.id])
                redirect caseInstance
            }
    ...
    def delete(Case caseInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'Case.label', default: 'Case'), caseInstance.id])
